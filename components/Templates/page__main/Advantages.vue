<template>
    <section v-if="data">
        ...
        <MoleculesSladerBase :data="data.body" :container-class="style.container" class="relative">
            <template #header>
                <div></div>
            </template>
            <template #item="{ elem }">
                <div class="h-full">
                    <div class="bg-gray-100 py-8 px-6 flex flex-col items-center h-full xl:py-6 xl:px-3">
                        <div
                            class="w-20 h-20 relative rounded-full overflow-hidden flex p-6 items-center justify-center mb-4
                            ...
                            <img :src="`/img/svg/${elem.link_img}.svg`" alt="" class="relative z-20">
                        </div>
