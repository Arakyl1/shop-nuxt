<template>
    <div class="relative">
        ...
        @mouseenter="showModalCategor" @mouseleave="hudeModalCategor">
            <div >
            <AtomButtonStandart class=" text-white flex items-center h-14 relative after:z-[-1] lg:h-12"
            ...
            <Transition name="categor">
                <div class="flex origin-top-left " v-show="stage" >
                    <MoleculesListSidebar class=" px-4 " @categor="(e) => updateCategor(e)" ref="categor"/>
                    <MoleculesListSelectAditional v-show="listCategor.children.length"
