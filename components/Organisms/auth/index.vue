<template>
    <AtomModalTransition class=" h-min w-[450px] sm:w-[calc(100vw-2rem)]" :active="stage">
        ...
        sm:py-6 sm:px-6">
            ...
            <template v-else>
                ...
                >{{ modalLogin ? 'Авторизация' : 'Регистрация' }}</h3>
                    <MoleculesAuthLogin v-if="modalLogin" :active="stage"/>
                    <MoleculesAuthRegister v-else :active="stage"/>
