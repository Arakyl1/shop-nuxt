import { SERVER_RESPONSE_CONTENT_KEY, AlertItemCreate } from "@/type/intex";
import { GET_CONTENT_KEY } from "../../utils/other";

export const _createResponseMessage = (key: SERVER_RESPONSE_CONTENT_KEY, state: AlertItemCreate['state'] = 'info') => ({ key: key, state: state })
